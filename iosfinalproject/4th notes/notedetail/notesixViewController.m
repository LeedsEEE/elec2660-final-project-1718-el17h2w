...
#import "notesixViewController.h"

@interface notesixViewController ()

@end

@implementation notesixViewController
    ...
    if (allchoice == 12){
        ...
        UIAlertAction *okayAction = [UIAlertAction
                                     ...
                                     handler:^(UIAlertAction *action) {
                                         _nextbutton62.hidden = true;
                                         _nextbutton61.hidden=false;
                                     }];
