...
-(instancetype)init
{
    ...
    if (self) {
        ...
        UKintroduction.cultureimage=@"UKimage";//taken from www.vcg.com//image of
        ...
        Architural.cultureimage =@"artchiturectionimage";//taken from www.vcg.com//image of
        ...
        Currency.cultureimage =@"currencyimage";//taken from www.vcg.com//image of
        ...
        Attraction.cultureimage =@"attractionimage";//taken from www.vcg.com//image of
        ...
        Traffic.cultureimage =@"trafficeimage";//taken from www.vcg.com//image of
        ...
        Tea.cultureimage =@"teaimage";//taken from www.vcg.com//image of
        ...
        Food.cultureimage =@"foodimage";//taken from www.vcg.com//image of
        ...
        Foodtruck.cultureimage =@"phoneboothimage";//taken from www.vcg.com//image of
        ...
        Phonebooth.cultureimage =@"National costumeimage";//taken from www.vcg.com//image of
        ...
        Premier.cultureimage =@"footimage";//taken from www.vcg.com//image of
        ...
        Gentleman.cultureimage =@"Politicsimage";//image taken from https://hojenjen.com//image of
        ...
        Weather.cultureimage =@"weatherimage";//taken from www.vcg.com//image of
        ...
        Boat.cultureimage =@"boatimage";//taken from www.vcg.com//image of
