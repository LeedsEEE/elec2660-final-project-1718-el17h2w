...
-(instancetype)init
{
    ...
    if (self) {
        ...
        Foodtruck.cultureimage =@"phoneboothimage.jpg";//taken from www.vcg.com
        Foodtruck.culturetitle =@"Red telephone box ";
